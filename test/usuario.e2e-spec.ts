...
describe('Testes dos Módulos Usuário e Auth (e2e)', () => {  // descrição do teste e2e
  ...
  it("01 - Deve criar um novo usuário", async () => {// testa se o usuario pode ser criado
    ...
    .post('/usuarios/cadastrar').send({ //envia uma requisição post para a rota /usuario/cadastrar
      nome: "Teste",
      usuario: "teste@gmail.com",
      senha: "12345678",
      foto: "https://i.imgur.com/FETvs20.jpg",
    }).expect(201); // espera que a resposta seja 201 (created)
  usuarioid = resposta.body.id; // salva o id do usuario criado na variavel usuarioid
  });
  ...
  it("05 - Deve Atualizar um Usuário", async() => {
    ...
    .send({
      ...
      usuario: "teste_atualizado@gmail.com",
      senha: "12345678",
      foto: "https://i.imgur.com/FETvs20.jpg"
    })
    .expect(200)
    .then( resposta => {
      expect("Teste Atualizado").toEqual(resposta.body.nome); // verifica se o nome do usuario foi atualizado corretamente
    })
